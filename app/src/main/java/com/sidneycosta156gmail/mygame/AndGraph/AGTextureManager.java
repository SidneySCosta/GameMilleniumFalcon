...
//Engine Package
package com.sidneycosta156gmail.mygame.AndGraph;
...
class AGTextureManager 
{
	...
	******************************************/
	...
	//METODO CRIADO PARA SITUACOES DE CENA QUE UTILIZAM O METODO SETTEXTURA DO SPRITE
	public static void deleteAll()
	{
		for (int iIndex=0; iIndex < vrTextureList.size(); iIndex++)
		{
			vrTextureList.get(iIndex).iImageRef = 0;
		}
		vrTextureList.clear();
	}
